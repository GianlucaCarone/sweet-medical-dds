  ...
  return (
    <div className="fade-in">
      <div className="border-bottom pb-3 mb-4">
        <h4 className="font-weight-bold text-dark mb-1">Puestos de Trabajo</h4>
        <p className="text-secondary small m-0">Administra las sedes médicas donde brindas atención.</p>
      </div>
                ...
                sedesAsignadas.map(sede => (
                  <div key={sede._id} className="sede-box-vinculada">
                    <div className="text-truncatepe" style={{ maxWidth: '75%' }}>
                      <p className="font-weight-bold text-dark mb-1 small">{sede.nombre}</p>
                      <p className="text-secondary mb-0" style={{ fontSize: '11px' }}>{sede.direccion}</p>
                    </div>
                    <button 
