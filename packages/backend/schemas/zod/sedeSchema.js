...
export const nombreSedeSchema = z.string({
  error: (issue) => issue.input === undefined ? "El nombre de la sede es obligatorio" : "El nombre de la sede debe ser una cadena de texto"
...
export const direccionSedeSchema = z.string({
  error: (issue) => issue.input === undefined ? "La dirección de la sede es obligatoria" : "La dirección de la sede debe ser una cadena de texto"
